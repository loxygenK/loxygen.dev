...
const DataSetURLs: Map<DataSet, string> = new Map(
  [
    ["achievements", "https://raw.githubusercontent.com/loxygenK/loxygenk.d/main/achievements.yaml"],
    ["fundamental", "https://raw.githubusercontent.com/loxygenK/loxygenk.d/main/fundamental.yaml"],
    ["technical", "https://raw.githubusercontent.com/loxygenK/loxygenk.d/main/technical.yaml"],
  ]
);
